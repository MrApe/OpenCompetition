...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Fr. Jul 9 10:48:31 2010
...
SOURCES       = main.cpp \
		...
		modules/results/resultswidget.cpp moc_importmodule.cpp \
		moc_competition.cpp \
		moc_opendialog.cpp \
		moc_mainwindow.cpp \
		...
		moc_startlistwidget.cpp \
		moc_startdataeditor.cpp \
		moc_scoreinputwidget.cpp \
		moc_scoreeditwidget.cpp \
		moc_resultswidget.cpp \
		qrc_ressources.cpp
OBJECTS       = main.o \
		importmodule.o \
		abstractimporter.o \
		...
		moc_startlistwidget.o \
		moc_startdataeditor.o \
		moc_scoreinputwidget.o \
		moc_scoreeditwidget.o \
		moc_resultswidget.o \
		qrc_ressources.o
...
$(TARGET): ui_importmodule.h ui_opendialog.h ui_mainwindow.h ui_newcompdialog.h ui_clublistwidget.h ui_propertieswidget.h ui_competitorlistwidget.h ui_aboutdialog.h ui_judgespanelwidget.h ui_judgeeditorwidget.h ui_startlistwidget.h ui_startdataeditor.h ui_scoreinputwidget.h ui_scoreeditwidget.h ui_resultswidget.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/OpenCompetition1.0.0/ && $(COPY_FILE) --parents modules/import/importmodule.h modules/import/abstractimporter.h data/abstractperson.h data/competitor.h data/group.h data/club.h data/tomanycompetitorsexception.h data/judge.h data/judgespanel.h data/competition.h modules/import/text/textimporter.h modules/import/filenotopenedexception.h modules/import/importpluginprovider.h ui/opendialog.h ui/mainwindow.h ui/newcompdialog.h data/abstractXMLElement.h modules/clublist/clublistwidget.h modules/modulefactory.h modules/abstractmodule.h ui/propertieswidget.h modules/competitorlist/competitorlistwidget.h ui/aboutdialog.h modules/judgespanel/judgespanelwidget.h modules/judgespanel/judgeeditorwidget.h modules/startlist/startlistwidget.h modules/startlist/startdataeditor.h modules/startlist/types.h data/score.h modules/scoreInput/scoreinputwidget.h modules/scoreInput/scoreeditwidget.h modules/results/resultswidget.h .tmp/OpenCompetition1.0.0/ && $(COPY_FILE) --parents ressources.qrc .tmp/OpenCompetition1.0.0/ && $(COPY_FILE) --parents main.cpp modules/import/importmodule.cpp modules/import/abstractimporter.cpp data/abstractperson.cpp data/competitor.cpp data/group.cpp data/club.cpp data/tomanycompetitorsexception.cpp data/judge.cpp data/judgespanel.cpp data/competition.cpp modules/import/text/textimporter.cpp modules/import/filenotopenedexception.cpp modules/import/importpluginprovider.cpp ui/opendialog.cpp ui/mainwindow.cpp ui/newcompdialog.cpp modules/clublist/clublistwidget.cpp modules/modulefactory.cpp ui/propertieswidget.cpp modules/competitorlist/competitorlistwidget.cpp ui/aboutdialog.cpp modules/judgespanel/judgespanelwidget.cpp modules/judgespanel/judgeeditorwidget.cpp modules/startlist/startlistwidget.cpp modules/startlist/startdataeditor.cpp data/score.cpp modules/scoreInput/scoreinputwidget.cpp modules/scoreInput/scoreeditwidget.cpp modules/results/resultswidget.cpp .tmp/OpenCompetition1.0.0/ && $(COPY_FILE) --parents modules/import/importmodule.ui ui/opendialog.ui ui/mainwindow.ui ui/newcompdialog.ui modules/clublist/clublistwidget.ui ui/propertieswidget.ui modules/competitorlist/competitorlistwidget.ui ui/aboutdialog.ui modules/judgespanel/judgespanelwidget.ui modules/judgespanel/judgeeditorwidget.ui modules/startlist/startlistwidget.ui modules/startlist/startdataeditor.ui modules/scoreInput/scoreinputwidget.ui modules/scoreInput/scoreeditwidget.ui modules/results/resultswidget.ui .tmp/OpenCompetition1.0.0/ && $(COPY_FILE) --parents lang/de_DE.ts .tmp/OpenCompetition1.0.0/ && (cd `dirname .tmp/OpenCompetition1.0.0` && $(TAR) OpenCompetition1.0.0.tar OpenCompetition1.0.0 && $(COMPRESS) OpenCompetition1.0.0.tar) && $(MOVE) `dirname .tmp/OpenCompetition1.0.0`/OpenCompetition1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/OpenCompetition1.0.0
...
compiler_moc_header_make_all: moc_importmodule.cpp moc_competition.cpp moc_opendialog.cpp moc_mainwindow.cpp moc_newcompdialog.cpp moc_clublistwidget.cpp moc_modulefactory.cpp moc_propertieswidget.cpp moc_competitorlistwidget.cpp moc_aboutdialog.cpp moc_judgespanelwidget.cpp moc_judgeeditorwidget.cpp moc_startlistwidget.cpp moc_startdataeditor.cpp moc_scoreinputwidget.cpp moc_scoreeditwidget.cpp moc_resultswidget.cpp
...
moc_startlistwidget.cpp: modules/abstractmodule.h \
		data/competition.h \
		data/judgespanel.h \
		data/judge.h \
		data/abstractperson.h \
	...
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) modules/startlist/startlistwidget.h -o moc_startlistwidget.cpp

moc_startdataeditor.cpp: data/competition.h \
		data/judgespanel.h \
		data/judge.h \
		data/abstractperson.h \
		data/abstractXMLElement.h \
	...
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) modules/startlist/startdataeditor.h -o moc_startdataeditor.cpp

moc_scoreinputwidget.cpp: modules/abstractmodule.h \
		data/competition.h \
		data/judgespanel.h \
		data/judge.h \
		data/abstractperson.h \
	...
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) modules/scoreInput/scoreinputwidget.h -o moc_scoreinputwidget.cpp

moc_scoreeditwidget.cpp: data/competition.h \
		data/judgespanel.h \
		data/judge.h \
		data/abstractperson.h \
		data/abstractXMLElement.h \
	...
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) modules/scoreInput/scoreeditwidget.h -o moc_scoreeditwidget.cpp

moc_resultswidget.cpp: modules/abstractmodule.h \
		data/competition.h \
		data/judgespanel.h \
		data/judge.h \
		data/abstractperson.h \
	...
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) modules/results/resultswidget.h -o moc_resultswidget.cpp
...
compiler_uic_make_all: ui_importmodule.h ui_opendialog.h ui_mainwindow.h ui_newcompdialog.h ui_clublistwidget.h ui_propertieswidget.h ui_competitorlistwidget.h ui_aboutdialog.h ui_judgespanelwidget.h ui_judgeeditorwidget.h ui_startlistwidget.h ui_startdataeditor.h ui_scoreinputwidget.h ui_scoreeditwidget.h ui_resultswidget.h
compiler_uic_clean:
	-$(DEL_FILE) ui_importmodule.h ui_opendialog.h ui_mainwindow.h ui_newcompdialog.h ui_clublistwidget.h ui_propertieswidget.h ui_competitorlistwidget.h ui_aboutdialog.h ui_judgespanelwidget.h ui_judgeeditorwidget.h ui_startlistwidget.h ui_startdataeditor.h ui_scoreinputwidget.h ui_scoreeditwidget.h ui_resultswidget.h
...
ui_startlistwidget.h: modules/startlist/startlistwidget.ui
	/usr/bin/uic-qt4 modules/startlist/startlistwidget.ui -o ui_startlistwidget.h

ui_startdataeditor.h: modules/startlist/startdataeditor.ui
	/usr/bin/uic-qt4 modules/startlist/startdataeditor.ui -o ui_startdataeditor.h

ui_scoreinputwidget.h: modules/scoreInput/scoreinputwidget.ui
	/usr/bin/uic-qt4 modules/scoreInput/scoreinputwidget.ui -o ui_scoreinputwidget.h

ui_scoreeditwidget.h: modules/scoreInput/scoreeditwidget.ui
	/usr/bin/uic-qt4 modules/scoreInput/scoreeditwidget.ui -o ui_scoreeditwidget.h

ui_resultswidget.h: modules/results/resultswidget.ui
	/usr/bin/uic-qt4 modules/results/resultswidget.ui -o ui_resultswidget.h
...
startlistwidget.o: modules/startlist/startlistwidget.cpp modules/startlist/startlistwidget.h \
		modules/abstractmodule.h \
		data/competition.h \
		data/judgespanel.h \
		data/judge.h \
		...
		data/tomanycompetitorsexception.h \
		modules/startlist/types.h \
		ui_startlistwidget.h \
		modules/startlist/startdataeditor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o startlistwidget.o modules/startlist/startlistwidget.cpp

startdataeditor.o: modules/startlist/startdataeditor.cpp modules/startlist/startdataeditor.h \
		data/competition.h \
		data/judgespanel.h \
		data/judge.h \
		data/abstractperson.h \
		...
		data/tomanycompetitorsexception.h \
		modules/startlist/types.h \
		ui_startdataeditor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o startdataeditor.o modules/startlist/startdataeditor.cpp

score.o: data/score.cpp data/score.h \
		data/abstractXMLElement.h \
		data/judge.h \
		data/abstractperson.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o score.o data/score.cpp

scoreinputwidget.o: modules/scoreInput/scoreinputwidget.cpp modules/scoreInput/scoreinputwidget.h \
		modules/abstractmodule.h \
		data/competition.h \
		data/judgespanel.h \
		data/judge.h \
		...
		data/score.h \
		data/tomanycompetitorsexception.h \
		ui_scoreinputwidget.h \
		modules/scoreInput/scoreeditwidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o scoreinputwidget.o modules/scoreInput/scoreinputwidget.cpp

scoreeditwidget.o: modules/scoreInput/scoreeditwidget.cpp modules/scoreInput/scoreeditwidget.h \
		data/competition.h \
		data/judgespanel.h \
		data/judge.h \
		data/abstractperson.h \
		...
		data/score.h \
		data/tomanycompetitorsexception.h \
		ui_scoreeditwidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o scoreeditwidget.o modules/scoreInput/scoreeditwidget.cpp

resultswidget.o: modules/results/resultswidget.cpp modules/results/resultswidget.h \
		modules/abstractmodule.h \
		data/competition.h \
		data/judgespanel.h \
		data/judge.h \
		...
		data/tomanycompetitorsexception.h \
		ui_resultswidget.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o resultswidget.o modules/results/resultswidget.cpp
...
moc_startlistwidget.o: moc_startlistwidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_startlistwidget.o moc_startlistwidget.cpp

moc_startdataeditor.o: moc_startdataeditor.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_startdataeditor.o moc_startdataeditor.cpp

moc_scoreinputwidget.o: moc_scoreinputwidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_scoreinputwidget.o moc_scoreinputwidget.cpp

moc_scoreeditwidget.o: moc_scoreeditwidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_scoreeditwidget.o moc_scoreeditwidget.cpp

moc_resultswidget.o: moc_resultswidget.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_resultswidget.o moc_resultswidget.cpp
